...
GO
ALTER PROCEDURE [dbo].[sp_ReportTransactions]
(
    @StartDate DATE,
    @EndDate DATE,
    @TransactionType INT
...
WHERE T.Status=1 AND T.TransactionType=@TransactionType AND CAST(T.DateC AS DATE) BETWEEN @StartDate AND @EndDate
